...
class DiffusionPrior(
  ...
  initialParams: (Double, Double, Double, Double) = (1.0*math.pow(10d, 0.506), 10d, 0d, -9.325)) extends
  ...
  protected var parameters: (Double, Double, Double, Double) = initialParams
