...
/**
  ...
  * */
case class MagConfigEncoding(keys: (String, String, String, String, String)) extends
  Encoder[Map[String, Double], (Double, Double, Double, Double, Double)] {

  override val i = DataPipe(
    (c: (Double, Double, Double, Double, Double)) => Map(
      keys._1 -> c._1,
      keys._2 -> c._2,
      keys._3 -> c._3,
      keys._4 -> c._4,
