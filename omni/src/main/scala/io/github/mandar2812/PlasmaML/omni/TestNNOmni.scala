...
object TestNNOmni {
  ...
  def runExperiment(
    ...
    //Load Omni data into a Iterable
    ...
    val modelTrainTest =
      (trainTest: (
        ...
        val gr =
          FFNeuralGraph(trainTest._1._1.head._1.length, 1, hidden, act, nCounts)
        ...
        val training_data = trainTest._1._1.toStream
        val model =
          new FeedForwardNetwork[Stream[(DenseVector[Double], Double)]](
            training_data,
            gr
          )
        ...
        val test_data = trainTest._1._2.toStream
