...
val getReLUAct2: Int => Int => Activation = (s: Int) =>
  (i: Int) => {
...
val exp_set2 = tuning_exp2.main(
  ...
  num_neurons = Seq(30, 25, 20),
  activation_func = getReLUAct2(1),
  iterations = 150000,
  iterations_tuning = 10000,
  miniBatch = 1024,
  optimizer = tf.train.AdaDelta(0.01),
  prior_type =
    Seq(helios.learn.cdt_loss.KullbackLeibler, helios.learn.cdt_loss.Hellinger),
  target_prob =
